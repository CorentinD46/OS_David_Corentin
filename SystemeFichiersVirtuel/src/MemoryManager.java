...
public class MemoryManager {
    ...
    private void writeSuperblock() {
        ...
        System.arraycopy(signature,BLOCK_SIZE,TOTAL_MEMORY,,MAX_INODES);
    ...
    public int allocateBlock() {
        for (int i = 129; i < NUM_BLOCKS; i++) {
            if (isBlockUsed(i) == 0) {  // Bloc libre trouvé !
            	setBlockUsed(i,true);// TODO: Le marquer comme occupé
            	return i;// TODO: L'annoncer à l'utilisateur/ le retourner
            }
        }
